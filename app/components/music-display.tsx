...
{
  /* <div className="flex justify-center items-center flex-col">
      <div className="px-10 grid grid-cols-1 lg:grid-cols-2 gap-36 flex justify-center items-center text-center">
        {albums.map((album) => (
          <div
            key={album.id}
            className="m-4 expand-on-load font-mono md:text-2xl">
            <div className="py-4">
              <h3 className="text-2xl">{album.title}</h3>
              <p>{album.type}</p>
              <p>{album.year}</p>
