...
export default function RequestAShowPage() {
  return (
    <div className="flex flex-col mx-auto w-full max-w-200 p-4">
      ...
      <p className="px-12 py-4 max-w-200">We'll play just about anywhere. Wanna have us play in your basement, your living room, or wherever? Let's make it happen! Fill out the form below to request a show.</p>
      <ShowRequestForm />
    </div>
  );
}