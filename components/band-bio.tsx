    ...
    <section className=" p-2 px-8 max-w-800 flex flex-col md:text-lg">
      ...
      <div className="py-3 lg:px-48 xl:px-64 2xl:px-96 ">
        <p className="text-outline">
          ...
          know that songs are meant to be heard and this music isn&apos;t doing
          much of anything locked in my head or saved on my computer. If by
          sharing my songs and my story I can help someone else even just a
