    ...
    <section className="p-2 px-8 max-w-800 flex flex-col md:text-lg">
      ...
      <div className="py-3 lg:px-48 xl:px-64 2xl:px-96 font-mono">
        <p className="text-outline">
          ...
          sober. I no longer felt the joy and sense of purpose I once did when I picked up the guitar. I was empty inside. I decided to set music aside while I adjusted to life
