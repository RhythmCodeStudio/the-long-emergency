export default function BlogPost() {
  return (
    <section className="max-w-800 text-outline">
      <div className="pb-3">
        <h3 className="text-center text-xl ">Welcome to The Long Emergency</h3>
        <h4 className="text-center text-lg">January 17, 1975</h4>
      </div>
      <div className="px-12 pb-3 lg:px-48 xl:px-64 2xl:px-96  text-outline">
        <p>
      ...
      <div className="px-12 py-3 lg:px-48 xl:px-64 2xl:px-96  text-outline">
        <p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellat
          ipsam officiis quidem quos sequi ab! Consequatur non neque harum
          possimus, atque, earum commodi suscipit incidunt veritatis nisi illo,
