...
export const Header = () => {
  ...
  return (
    <header 
      className={`p-4 ${currentPath!=="/" ? "bg-[url('/images/background-images/masks-no-text-4800x3190-gaps-filled-horizontal-25per.png')] bg-no-repeat bg-cover bg-center lg:bg-none" : " "}`}
    >
